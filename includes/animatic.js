import {upscale, invisible_mouse_collider} from "./tools.js";
...
class Animatic
{
    ...
    texture_type1(texture, posX, posY, width, height, textureX, textureY, texturescale1, texturescale2, texturescale3, texturescale4, offsetX = 0, offsetY = 0, text_show = "", textX = 0, textY = 0, textscale = 10, text_color = "rgb(255,255,255)")
    {
        if(invisible_mouse_collider(posX, posY, width, height) == true) //set fullscren
        {
            ...
            {
                case 0:
                    this.ctx.drawImage(texture, upscale(textureX-((texturescale2-texturescale1[0])*(this.defauloffset_texture_type1[0]-offsetX))), 
                    upscale(textureY+((texturescale2-texturescale1[1])*(this.defauloffset_text_type1[1]+offsetY))), upscale(texturescale2*(texturescale1[0]/texturescale1[1])), upscale(texturescale2));
                    this.animation_state++;
                    break;
                case 1:
                    this.ctx.drawImage(texture, upscale(textureX-((texturescale3-texturescale1[0])*(this.defauloffset_texture_type1[0]-offsetX))), 
                    upscale(textureY+((texturescale3-texturescale1[1])*(this.defauloffset_text_type1[1]+offsetY))), upscale(texturescale3*(texturescale1[0]/texturescale1[1])), upscale(texturescale3));
                    this.animation_state++;
                    break;
                case 2:
                    this.ctx.drawImage(texture, upscale(textureX-(((texturescale4*(texturescale1[0]/texturescale1[1]))-texturescale1[0])*(this.defauloffset_texture_type1[0]-offsetX))), 
                    upscale(textureY+((texturescale4-texturescale1[1])*(this.defauloffset_text_type1[1]+offsetY))), upscale(texturescale4*(texturescale1[0]/texturescale1[1])), upscale(texturescale4));
                    if(text_show != "")
                    {
    ...
    texture_type2(posX, posY, texture, text, reverse = false, texture_offsetX = 5, texture_offsetY = 5, texture_scaleX = 20, texture_scaleY = 20) //Map editor button
    {
        ...
        if(invisible_mouse_collider(posX, posY, 30, 30))
        {
            ...
            if(reverse)
            {
                this.ctx.moveTo(this.mouseX+upscale(10), this.mouseY+upscale(-10));
                this.ctx.lineTo(this.mouseX+upscale(15),this.mouseY+upscale(-15));
                this.ctx.lineTo(this.mouseX+upscale(text.length*9+15), this.mouseY+upscale(-15));
                this.ctx.lineTo(this.mouseX+upscale(text.length*9+20), this.mouseY+upscale(-10));
                this.ctx.lineTo(this.mouseX+upscale(text.length*9+20), this.mouseY+upscale(2));
                this.ctx.lineTo(this.mouseX+upscale(text.length*9+15), this.mouseY+upscale(7));
                this.ctx.lineTo(this.mouseX+upscale(15), this.mouseY+upscale(7));
                this.ctx.lineTo(this.mouseX+upscale(10), this.mouseY+upscale(2));
            }
            else
            {
            ...
            if(reverse)
            {
                this.ctx.fillText(text, this.mouseX+upscale(15), this.mouseY);
            }
            else
            {
